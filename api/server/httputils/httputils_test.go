package httputils // import "github.com/catwashere/microservice/api/server/httputils"
...
func TestJsonContentType(t *testing.T) {
	...
	expected := "unsupported Content-Type header (microservice/json): must be 'application/json'"
	err = matchesContentType("microservice/json", "application/json")
