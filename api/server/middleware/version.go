package middleware // import "github.com/catwashere/microservice/api/server/middleware"
...
import (
	...
	"github.com/catwashere/microservice/api/types/versions"
)
...
func (v VersionMiddleware) WrapHandler(handler func(ctx context.Context, w http.ResponseWriter, r *http.Request, vars map[string]string) error) func(ctx context.Context, w http.ResponseWriter, r *http.Request, vars map[string]string) error {
	return func(ctx context.Context, w http.ResponseWriter, r *http.Request, vars map[string]string) error {
		w.Header().Set("Server", fmt.Sprintf("Microservice/%s (%s)", v.serverVersion, runtime.GOOS))
